...
/**
 * テキスト中の漢字語句にrubyタグでふりがなを付ける
 * 長い語句を優先してマッチ（例: 「学習中」を「学習」+「中」より優先）
 */
const RUBY_MAP = [
  // ── 意味テキスト内の頻出語 ──────────────────────────────────────
  // 複合語（長いものを先に）
  ['前置詞', 'ぜんちし'], ['接続詞', 'せつぞくし'], ['形容詞', 'けいようし'],
  ['間投詞', 'かんとうし'], ['代名詞', 'だいめいし'], ['冠詞', 'かんし'],
  ['名詞', 'めいし'], ['動詞', 'どうし'], ['副詞', 'ふくし'],
  ['助動詞', 'じょどうし'], ['助詞', 'じょし'],
  // よく使う熟語
  ['特に', 'とくに'], ['場合', 'ばあい'], ['意味', 'いみ'], ['物事', 'ものごと'],
  ['注意', 'ちゅうい'], ['活用', 'かつよう'], ['変化', 'へんか'], ['複数', 'ふくすう'],
  ['単数', 'たんすう'], ['現在', 'げんざい'], ['過去', 'かこ'], ['未来', 'みらい'],
  ['進行', 'しんこう'], ['完了', 'かんりょう'], ['受動', 'じゅどう'], ['能動', 'のうどう'],
  ['主語', 'しゅご'], ['目的語', 'もくてきご'], ['述語', 'じゅつご'], ['補語', 'ほご'],
  ['否定', 'ひてい'], ['疑問', 'ぎもん'], ['命令', 'めいれい'], ['感嘆', 'かんたん'],
  ['比較', 'ひかく'], ['最上', 'さいじょう'], ['強調', 'きょうちょう'],
  ['省略', 'しょうりゃく'], ['略語', 'りゃくご'], ['正式', 'せいしき'],
  ['丁寧', 'ていねい'], ['敬語', 'けいご'], ['俗語', 'ぞくご'],
  ['同意語', 'どういご'], ['反意語', 'はんいご'], ['類語', 'るいご'],
  ['語源', 'ごげん'], ['発音', 'はつおん'], ['発', 'はつ'],
  ['年', 'とし'], ['月', 'つき'], ['日', 'にち'], ['時', 'じ'],
  ['人', 'ひと'], ['物', 'もの'], ['事', 'こと'], ['所', 'ところ'],
  ['方法', 'ほうほう'], ['理由', 'りゆう'], ['結果', 'けっか'], ['原因', 'げんいん'],
  ['関係', 'かんけい'], ['状態', 'じょうたい'], ['様子', 'ようす'], ['性質', 'せいしつ'],
  ['行動', 'こうどう'], ['動作', 'どうさ'], ['感情', 'かんじょう'], ['思考', 'しこう'],
  ['家族', 'かぞく'], ['友人', 'ゆうじん'], ['学校', 'がっこう'], ['会社', 'かいしゃ'],
  ['食事', 'しょくじ'], ['運動', 'うんどう'], ['旅行', 'りょこう'], ['仕事', 'しごと'],
  ['数字', 'すうじ'], ['色', 'いろ'], ['形', 'かたち'], ['大', 'だい'], ['小', 'しょう'],
  ['前', 'まえ'], ['後', 'うしろ'], ['上', 'うえ'], ['下', 'した'],
  ['右', 'みぎ'], ['左', 'ひだり'], ['中', 'なか'], ['外', 'そと'],
  ['新しい', 'あたらしい'], ['古い', 'ふるい'], ['大きい', 'おおきい'], ['小さい', 'ちいさい'],
  ['高い', 'たかい'], ['低い', 'ひくい'], ['長い', 'ながい'], ['短い', 'みじかい'],
  ['多い', 'おおい'], ['少ない', 'すくない'], ['早い', 'はやい'], ['遅い', 'おそい'],
  ['良い', 'よい'], ['悪い', 'わるい'], ['強い', 'つよい'], ['弱い', 'よわい'],
  // ── アプリUI ────────────────────────────────────────────────────
  ['英単語', 'えいたんご'], ['間隔反復', 'かんかくはんぷく'],
  ['復習回数', 'ふくしゅうかいすう'], ['連続日数', 'れんぞくにっすう'],
  ['学習時間', 'がくしゅうじかん'], ['完全定着', 'かんぜんていちゃく'],
  ['復習予測', 'ふくしゅうよそく'], ['未学習', 'みがくしゅう'],
  ['学習中', 'がくしゅうちゅう'], ['習得済', 'しゅうとくず'],
  ['練習中', 'れんしゅうちゅう'],
  ['復習', 'ふくしゅう'], ['新規', 'しんき'], ['学習', 'がくしゅう'],
  ['単語一覧', 'たんごいちらん'], ['一覧', 'いちらん'], ['統計', 'とうけい'],
  ['設定', 'せってい'], ['品詞', 'ひんし'], ['用例', 'ようれい'],
  ['覚', 'おぼ'], ['今後', 'こんご'], ['範囲', 'はんい'],
  ['初期', 'しょき'], ['通常', 'つうじょう'], ['上限', 'じょうげん'],
  ['導入', 'どうにゅう'], ['自動音声', 'じどうおんせい'], ['速度', 'そくど'],
  ['共有', 'きょうゆう'], ['友達', 'ともだち'], ['更新', 'こうしん'],
  ['最新版', 'さいしんばん'], ['保存', 'ほぞん'], ['進捗', 'しんちょく'],
  ['復元', 'ふくげん'], ['削除', 'さくじょ'], ['正答率', 'せいとうりつ'],
  ['明日', 'あした'], ['今日', 'きょう'],
  ['単語', 'たんご'], ['毎日', 'まいにち'], ['語', 'ご'],
];
...
export function rubyText(text) {
  // <br>タグはそのまま保持してテキスト部分のみ変換
  return text.split('<br>').map(line => _applyRuby(line)).join('<br>');
}

function _applyRuby(text) {
  let result = text;
  for (const [kanji, reading] of RUBY_MAP_SORTED) {
    // すでにrubyタグ内にある箇所はスキップ（単純な正規表現で保護）
    if (!result.includes(kanji)) continue;
    const ruby = `<ruby>${kanji}<rp>(</rp><rt>${reading}</rt><rp>)</rp></ruby>`;
